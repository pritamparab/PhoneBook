...
class updatepeople(Toplevel):
    def __init__(self, person_id):
        ...
        self.heading = Label(self.first, text="Update Contact", bg='white', fg='black', font='algerian 20 bold')
        ...
        # submit button
        button = Button(self.last, text='Update Contact', bg='white', command=self.updatepeople)
    ...
    def updatepeople(self):
        ...
        query = "update 'addressbook' set name='{}', surname='{}', phone='{}', email='{}', address='{}' where ID='{}'".format(name, surname, phone, email, address, id)
        try:
            cur.execute(query)
            con.commit()
